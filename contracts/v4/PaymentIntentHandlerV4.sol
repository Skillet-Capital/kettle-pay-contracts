...
contract PaymentIntentHandlerV4 is
    IPaymentHook,
    ISwapTarget,
    Signatures,
    ReentrancyGuard,
    AccessControl
{
    ...
    event PaymentIntentFailed(bytes32 indexed nonce, bytes32 indexed orderId, string reason);
    ...
    function localExecuteHook(
        ...
        return _localExecuteHook(_intent, _orderId, _signature);
    }
    ...
    function _localExecuteHook(
        ...
        _consumeIntent(_intent, _orderId, _signature);
    ...
    function executePaymentHook(
        ...
        returns (bool result) {
            ...
            emit PaymentIntentFailed(_nonce, _hookData.orderId, reason);
            return false;
        } catch {
            emit PaymentIntentFailed(_nonce, bytes32(0), "Unknown error");
            return false;
        }
    }
    ...
    function _consumeIntent(
        ...
        require(!orderIds[_orderId], "Order ID already used");
